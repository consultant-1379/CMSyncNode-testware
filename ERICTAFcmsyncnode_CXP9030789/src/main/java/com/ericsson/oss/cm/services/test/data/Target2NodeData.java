...
public class Target2NodeData extends TargetNodeData {
    ...
    public List<Map<String, Object>> dataSource() {
        ...
        SynchNodeTestData synchNodePojo = generateTestData(2,simList,true);
        
        Map<String, Object> data = Collections.<String, Object> singletonMap("TargetSync2Nodes", synchNodePojo);
