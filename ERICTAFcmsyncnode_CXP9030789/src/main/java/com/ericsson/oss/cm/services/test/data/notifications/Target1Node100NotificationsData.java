...
public class Target1Node100NotificationsData extends TargetNodeData {
    ...
    public List<Map<String, Object>> dataSource() {
        ...
        Map<String, Object> data = Collections.<String, Object> singletonMap("TargetSync1Node100Notification", synchNodePojo);
