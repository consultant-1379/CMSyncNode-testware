...
public class Target1000NodeData extends TargetNodeData{
    ...
    public List<Map<String, Object>> dataSource() {
        ...
        simList.add(CmSynchConstants.NETSIM_NAME_D_1K);
        
        SynchNodeTestData synchNodePojo = generateTestData(1000,simList,false);
        
        Map<String, Object> data = Collections.<String, Object> singletonMap("TargetSync1000Nodes", synchNodePojo);
