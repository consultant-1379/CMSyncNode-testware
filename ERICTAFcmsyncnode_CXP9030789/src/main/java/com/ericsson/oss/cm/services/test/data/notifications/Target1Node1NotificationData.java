...
public class Target1Node1NotificationData extends TargetNodeData {
    ...
    public List<Map<String, Object>> dataSource() {
        ...
        Map<String, Object> data = Collections.<String, Object> singletonMap("TargetSync1Node1Notification", synchNodePojo);
