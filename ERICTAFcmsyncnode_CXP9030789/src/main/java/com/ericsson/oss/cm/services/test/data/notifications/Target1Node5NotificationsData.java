...
public class Target1Node5NotificationsData extends TargetNodeData {
    ...
    public List<Map<String, Object>> dataSource() {
        ...
        Map<String, Object> data = Collections.<String, Object> singletonMap("TargetSync1Node5Notification", synchNodePojo);
...
//            NotificationMORequest notificationRequest = new NotificationMORequest("ManagedElement=1,ENodeBFunction=1", "EUtranCellFDD", "TAF" + i);
            Map<String,Object> map = new HashMap<String, Object>();
            map.put("userLabel", "TAF" + i); 
            notificationRequest.setAttributes(map);
