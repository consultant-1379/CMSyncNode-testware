...
public class Target5Node1NotificationsData extends TargetNodeData {
    ...
    public List<Map<String, Object>> dataSource() {
        ...
        simList.add(CmSynchConstants.NETSIM_NAME_D_1_1_NOTIFICATIONS);
        ...
        Map<String, Object> data = Collections.<String, Object> singletonMap("TargetSync5Node1Notification", synchNodePojo);
